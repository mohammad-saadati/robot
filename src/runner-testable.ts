...
export function buildGraph(edges: string[]): RoadGraph {
...
export const roadGraph: RoadGraph = buildGraph(roads);

// Create a simple robot function
export function randomRobot(state: VillageState): RobotResult {
...
export function createState(): VillageState {
...
export function findRoute(graph: RoadGraph, from: string, to: string): string[] {
...
export function goalOrientedRobot({ place, parcels }: VillageState, route: string[]): RobotResult {
  if (route.length == 0) {
...
export function routeRobot(state: VillageState, memory: string[]): RobotResult {
  if (memory.length == 0) {
    memory = mailRoute;
  }
...
export function lazyRobot({ place, parcels }: VillageState, route: string[]): RobotResult {
  if (route.length == 0) {
